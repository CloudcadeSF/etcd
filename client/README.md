...
[![GoDoc](https://godoc.org/github.com/CloudcadeSF/etcd/client?status.png)](https://godoc.org/github.com/CloudcadeSF/etcd/client)
...
```bash
go get github.com/CloudcadeSF/etcd/client
```
