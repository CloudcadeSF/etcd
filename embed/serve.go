...
import (
	...
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3election"
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/CloudcadeSF/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3lock"
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/CloudcadeSF/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3rpc"
	etcdservergw "github.com/CloudcadeSF/etcd/etcdserver/etcdserverpb/gw"
