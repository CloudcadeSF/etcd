...
running(leaking) after all tests.
	...
	import "CloudcadeSF/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "CloudcadeSF/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "CloudcadeSF/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
