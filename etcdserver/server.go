...
import (
	...
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3alarm"
	"github.com/CloudcadeSF/etcd/etcdserver/api/v3compactor"
...
var (
	plog = capnslog.NewPackageLogger("github.com/CloudcadeSF/etcd", "etcdserver")
