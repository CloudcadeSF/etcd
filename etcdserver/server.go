...
import (
	...
	"CloudcadeSF/etcd/etcdserver/api/v3alarm"
	"CloudcadeSF/etcd/etcdserver/api/v3compactor"
...
var (
	plog = capnslog.NewPackageLogger("CloudcadeSF/etcd", "etcdserver")
